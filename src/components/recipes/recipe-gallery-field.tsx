...
export function createGalleryItemId(): string {
...
export function RecipeGalleryField({
  ...
  const [previewItem, setPreviewItem] = useState<GalleryFormItem | null>(null);

  const maxItems = RECIPE_REPEATER_LIMITS.gallery.max;
